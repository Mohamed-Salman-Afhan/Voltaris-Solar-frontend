...
export default function HeroSection() {
  return (
    <div className="bg-background px-12 font-[Inter] text-foreground">
      {/* Navigation Bar */}
      <nav className="flex flex-wrap items-center justify-between py-6">
        <div className="flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-accent sm:h-12 sm:w-12">
            <Wind className="h-5 w-5 text-primary-foreground sm:h-6 sm:w-6" />
          </div>
        ...
        <div className="flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary sm:h-12 sm:w-12">
            <Sailboat className="h-5 w-5 text-primary-foreground sm:h-6 sm:w-6" />
          </div>
          <span className="text-center text-xs font-medium text-foreground sm:text-left sm:text-sm">
            Home Dashboard
          </span>
        ...
        <div className="flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-accent sm:h-12 sm:w-12">
            <Triangle className="h-5 w-5 text-primary-foreground sm:h-6 sm:w-6" />
          </div>
          <span className="text-center text-xs font-medium text-foreground sm:text-left sm:text-sm">
      ...
      <main className="px-4 py-4 md:px-6 md:py-16">
        <div>
          ...
          <div className="mb-12 md:mb-24">
            <h1 className="text-4xl leading-tight font-semibold text-foreground sm:text-5xl sm:leading-20 md:text-7xl md:leading-32 xl:text-8xl">
              ...
              <div className="flex flex-row items-center gap-4 sm:gap-8">
                ...
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary sm:h-14 sm:w-14 md:h-16 md:w-16">
                  <Triangle className="h-5 w-5 text-primary-foreground sm:h-7 sm:w-7 md:h-8 md:w-8" />
                </div>
              </div>
            </h1>
          </div>
