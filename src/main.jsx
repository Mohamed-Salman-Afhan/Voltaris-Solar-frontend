              ...
              <Route element={<ProtectedLayout />}>
                ...
                <Route element={<AuthorizedLayout />}>
                  <Route element={<AdminLayout />}>
                    ...
                    <Route
                      path="/admin/solar-units"
                      element={<SolarUnitsPage />}
                    />
                    <Route
                      path="/admin/solar-units/:id"
                      element={<SolarUnitDetailPage />}
                    />
                    <Route
                      path="/admin/solar-units/:id/edit"
                      element={<SolarUnitEditPage />}
                    />
                    <Route
                      path="/admin/solar-units/create"
